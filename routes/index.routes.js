...
indexRoutes.post('/createLiasonig', upload.fields([{ name: "SitePhoto", maxCount: 1 }, { name: "OtherPhoto", maxCount: 1 }]), createLiasoning);
...
indexRoutes.post('/createCommercialMarket', upload.fields([{ name: "adharCard", maxCount: 1 }, { name: "lightBill", maxCount: 1 }, { name: "veraBill", maxCount: 1 }, { name: "SitePhoto", maxCount: 1 }, { name: "OtherPhoto", maxCount: 1 }]), createcommercialMarket);
...
indexRoutes.put('/updateCommercial/:id', upload.fields([{ name: "adharCard", maxCount: 1 }, { name: "lightBill", maxCount: 1 }, { name: "veraBill", maxCount: 1 }, { name: "SitePhoto", maxCount: 1 }, { name: "OtherPhoto", maxCount: 1 }]), updateCommercialMarket);
