...
exports.createcommercialMarket = async (req, res) => {
    try {
        ...
        if (MarketingType === "Commercial Marketing") {
            ...
            let { fileDate, fileNo, FQPayment, AmountL, AmountDate, SerialNumber, SerialNumberDate,
                ...
                Query3, Query4, Query5, fillNo, Date, ContactPersonName, Dealer, PhoneNumber, Address, City_Village, District_Location, Longitude, Pincode, Latitude, Amount, GST, TotalAmount, ConsumerName, DealerCommission, ConsumerNumber, ConnectionLoad, Tarrif, AverageMonthlyBill, GSTNumber, PanNumber, MSME_UdyamREGISTRATION, Phase, adharCard, lightBill, veraBill, status } = req.body;
        ...
        if (MarketingType === "Residential Marketing") {
            ...
            let { fileDate, fileNo, FQPayment, AmountL, AmountDate, SerialNumber, SerialNumberDate,
                addmorephotos, SitePhoto, OtherPhoto, CheckBox1, CheckBox1date, CheckBox2, CheckBox2date, CheckBox3, CheckBox3date, CheckBox4, CheckBox4date, CheckBox5, CheckBox5date, Query1, Query2,
                Query3, Query4, Query5, fillNo, Date, ConsumerName, PhoneNumber, ConsumerNumber, Address, City_Village, District_Location, Pincode, Latitude, Longitude,
...
exports.getAllCommercialmarket = async (req, res) => {
    try {
        ...
        return res.status(200).json({ status: 200, TotalCommercialMarket: count, message: 'All CommercialMarket Found Successfully..', commercialMarket: paginatedRCommercialMarket, dealer: getdDealerData })
