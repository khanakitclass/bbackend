...
exports.createDealer = async (req, res) => {
    try {
        let { ConsumerName, Location, adharCard, lightBill, veraBill, PhoneNumber, amount, status } = req.body;
...
exports.getAllDealers = async (req, res) => {
    try {
        ...
        return res.status(200).json({ status: 200, totalDealersEntery: count, message: "All Dealer Entery Found SuccessFully", Dealer: paginatedDealer })
...
exports.getDealerById = async (req, res) => {
    try {
        ...
        return res.status(200).json({ status: 200, message: "Dealer Entery Found SuccessFully...", Dealer: getdealer });
